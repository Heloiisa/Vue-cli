                ...
                <b-row>
                    <b-col md="6" sm="6">
                        <b-form-group label="Nome da Empresa:" label-for="nm_empresa">
                            <b-form-input id="nm_empresa" type="text" v-model="category.nm_empresa" required :readonly="mode === 'remove'" placeholder="Informe o Nome da Empresa..." />
                        </b-form-group>
                    </b-col>
                    <b-col md="6" sm="6">
                        <b-form-group label="Nome Fantasia:" label-for="idEmpresaFantasia">
                            <b-form-input id="idEmpresaFantasia" type="text" v-model="category.nm_empresa_fantasia" :readonly="mode === 'remove'" placeholder="Informe o Nome Fantasia..." />
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row>
                    ...
                    <b-col md="6" sm="12">
                        <b-form-group label="CNPJ:" label-for="idDocumentoEmpresa">
                            <b-form-input id="idDocumentoEmpresa" type="text" v-model="category.nm_nr_cnpj" required :readonly="mode === 'remove'" placeholder="Informe o CNPJ da Empresa..." />
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col md="6" sm="12">
                        <b-form-group label="Email da Empresa:" label-for="idEmailEmpresa">
                            <b-form-input id="idEmailEmpresa" type="text" v-model="category.nm_email" required :readonly="mode === 'remove'" placeholder="Informe o Email da Empresa..." />
                        </b-form-group>
                    </b-col>
                    <b-col md="1" sm="12">
                        <b-form-group label="DDD:" label-for="idTelefone">
                            <b-form-input id="idTelefone" type="text" v-model="category.nr_ddd_telefone" required :readonly="mode === 'remove'" placeholder="Inf. o DDD." />
                        </b-form-group>
                    </b-col>
                    <b-col md="5" sm="12">
                        <b-form-group label="Telefone:" label-for="idTelefone">
                            <b-form-input id="idDDD" type="text" v-model="category.nr_telefone" required :readonly="mode === 'remove'" placeholder="Informe o telefone..." />
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row>
